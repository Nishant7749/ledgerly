...
import { SignUp } from "../services/expAPI"
        ...
        <>
            <div className="flex justify-center items-center h-108">
                ...
                <h1 className="text-3xl font-bold text-gray-700 uppercase flex items-center justify-center mb-6">signup</h1>
                    ...
                    <p className="text-sm text-gray-400">Account Already Exists?  <Link to="/auth/login" className="text-blue-400 hover:text-blue-500">LogIn</Link></p>
